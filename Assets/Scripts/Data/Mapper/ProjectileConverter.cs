...
namespace Octoio.Fey.Data.Mapper
{
    ...
    public class ProjectileConverter : JsonConverter
    {
        public override bool CanConvert(System.Type objectType)
        {
            return typeof(Projectile).IsAssignableFrom(objectType);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var enumType = EEnum.Parse<Type.Projectile>(type);
            var target = enumType switch
            {
                Type.Projectile.Homing => new ProjectileHoming(),
                _ => null as Projectile
            }
